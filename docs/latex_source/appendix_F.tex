...
The dissertation was originally proposed as a systematic audit of AI responses to a standardised battery of mental health queries, varying the implied geographic location of the user across twenty cities spanning different income levels, healthcare infrastructure, and cultural contexts, with responses evaluated across four dimensions: crisis-line accuracy benchmarked against WHO Mental Health Atlas ground truth, service referral type, cultural assumption coding, and response specificity. A mixed-methods approach combining automatic metrics across all responses with structured human coding on a stratified subset, with inter-rater reliability testing, was proposed throughout.
...
\textbf{Model selection.} The original proposal envisaged a different, unspecified set of large language models. The seven models actually used (Section 3.2.3) were selected instead, on the basis of API accessibility and a mix of open-weight and commercial models providing broader coverage of the current LLM landscape than the originally envisaged set.

\textbf{Reduction from four evaluation dimensions to three outcome families.} Following supervisory feedback, the design was reduced to actionability, localisation and support orientation, each linked to one hypothesis, predictor and statistical model. Crisis-contact accuracy is reported as an exploratory audit rather than a fourth confirmatory hypothesis because it emerged after the confirmatory design was fixed. Throughout the revised dissertation this is described as an audit of verified, visibly suspicious and unresolved contacts, not as a fabrication analysis.
