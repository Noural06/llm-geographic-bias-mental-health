...
\small
\centering
\caption{Complete metric specification: every pipeline component, extraction rule, examples, known failure cases, and validation score.}
\label{tab:metric_spec}
\begin{tabularx}{\linewidth}{p{2.0cm} p{1.6cm} p{3.2cm} p{2.8cm} p{2.8cm} p{3.2cm} p{2.0cm}}
\toprule
...
\addlinespace
\texttt{actionability\_v2} & 0--5 & Sum of five binary components above; one point per component present. See Equation (3.4). F1 = 0.744 vs 112 human labels & & & Presence of features, not accuracy; a fabricated crisis number scores equally to a verified one & F1 = \textbf{0.744}, $\kappa_w$ = 0.619 \\
\midrule
