...
The main corpus spans 20 locations, 8 frozen scenarios, and 7 models (1,120 responses). The full scenario battery and location grid are reproduced in the dissertation appendices. The stability test reuses S1 and S8 for Kabul, Lagos and London.
